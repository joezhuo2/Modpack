...
//https://github.com/KnightMiner/Ceramics/tree/1.20/src/generated/resources/data/ceramics/recipes
...
function smelting(event, input, output, exp, time) {
    event.custom({
...
global.smelting = smelting
function blasting(event, input, output, exp, time) {
    event.custom({
